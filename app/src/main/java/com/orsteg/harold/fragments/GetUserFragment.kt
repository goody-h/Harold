 ...
 * Use the [GetUserFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class GetUserFragment : BaseFragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): GetUserFragment {
            val fragment = GetUserFragment()
            val args = Bundle()
