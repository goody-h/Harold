 ...
 * [TemplateLevelFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [TemplateLevelFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TemplateLevelFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): TemplateLevelFragment {
